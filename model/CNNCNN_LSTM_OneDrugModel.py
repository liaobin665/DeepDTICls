...
class CNNCNN_LSTM_OneDrugModel(object):
    ...
    def model(self, dropout, filters, prot_len=2500, activation='relu', initializer="glorot_normal", drug_len1=2048):
        ...
        layer_drug = Lambda(lambda x: K.expand_dims(x, axis=1))(input_drug)
        ...
        layer_compact = Bidirectional(LSTM(128))(layer_compact)
        # layer_compact = Dense(128, activation='relu', activity_regularizer=l2(0.0001), **params_dic)(layer_compact)
