...
drug = pd.read_csv("drug_encoding_ESPF.csv",index_col="Compound_ID")
...
total_protein_drug_ESPF_Lable = pd.concat([dti_df_combine2.loc[:,'0_x':'2499_x'], dti_df_combine2.loc[:,'0_y':'2585'],dti_df_combine2['Label']],axis=1)

total_protein_drug_ESPF_Lable.to_csv("total_protein_drug_ESPF_Lable.csv",index=None)
print("stop")