...
drug = pd.merge(drug,drug_Pubchem, on="Compound_ID")
...
total = pd.concat([dti_df_combine2.loc[:, '0_pro':'2499_pro'],
                   dti_df_combine2.loc[:,'0_espf':'2585_espf'], dti_df_combine2.loc[:,'0_rdkit':'199_rdkit'],
                   dti_df_combine2.loc[:,'0_pubchem':'880_pubchem'],dti_df_combine2['Label']], axis=1)

total.to_csv("total_protein_drug_ESPF_rdkit2D_pubchem_Lable.csv", index=None)
print("stop")